...
<body>
            ...
            <div class="offcanvas-body">
                <div class="order-md-last">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="badge bg-primary rounded-pill">{{ collect($myBooks)->count() }}</span>
                    </h4>
                    <ul class="list-group mb-3">
                        @foreach ($myBooks as $book)
                            <li class="list-group-item border-0 shadow-sm rounded-3 mb-3 p-3 book-item-hover">
                                <div class="d-flex align-items-center">

                                    {{-- 1. Зображення (Фіксований розмір + гарний кроп) --}}
                                        ...
                                        <div class="position-relative" style="width: 80px; height: 110px;">
                                            @if ($book->preview_image)
                                                <img src="{{ asset('storage/' . $book->preview_image) }}"
                                                    alt="{{ $book->title }}" class="w-100 h-100 rounded shadow-sm"
                                                    style="object-fit: cover;">
                                            @else
                                                <img src="{{ asset('assets/no-image.png') }}" alt="Немає фото"
                                                    class="w-100 h-100 rounded shadow-sm bg-light p-2"
                                    ...
                                    {{-- 3. Кнопки дій (Згруповані) --}}
                                    <div class="flex-shrink-0 ms-3">
                                        <div class="d-flex flex-column gap-2">

                                            {{-- Перегляд --}}
                                            {{-- <a href="{{ route('book.show', $book->id) }}"
                                                class="btn btn-light btn-sm text-primary shadow-sm"
                                                title="Переглянути">
                                            ...
                                            {{-- Редагування --}}
                                            <a href="{{ route('main.book.edit', $book->id) }}"
                                                class="btn btn-light btn-sm text-success shadow-sm"
                                                title="Редагувати">
                    ...
                    <a href="{{ route('main.book.create') }}" class="w-100 btn btn-primary btn-lg">Place an ad</a>
                </div>
            </div>
        </div>
    @endif
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasSearch"
        ...
        <div class="offcanvas-body">
            <div class="order-md-last">
                ...
                <form role="search" action="{{ route('front-page') }}" method="get" class="d-flex mt-3 gap-0">
    ...
    <header>
        <div class="container-fluid">
            <div class="row py-3 border-bottom">
                ...
                <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-5 d-none d-lg-block">
                    <div class="search-bar row bg-light p-2 my-2 rounded-4">
                        ...
                        <form id="search-form" class="text-center" action="{{ route('front-page') }}"
                            method="get">
                            <input type="text" class="form-control border-0 bg-transparent"
                                placeholder="Search for more than 20,000 products" name="search" />
                        </form>
                    </div>
                    <div class="col-1">
            ...
            <div
                ...
                <ul class="d-flex justify-content-end list-unstyled m-0">
                    <li>
                        <a href="{{ auth()->check() ? route('main.users.show', auth()->id()) : route('login') }}"
        ...
        @if (isset($categories) && isset($authors))
            <div class="container-fluid">
                <div class="row py-3">
                                    ...
                                    <ul
                                        ...
                                        @foreach ($authors->take(4) as $author)
                                            <li class="nav-item active">
                                                <a href="{{ request()->fullUrlWithQuery(['author_id' => $author->id, 'page' => null]) }}"
                                                    class="nav-link">
                                                    {{ $author->name }}
                                                </a>
                                            </li>
